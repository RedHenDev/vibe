...
AFRAME.registerSystem('npc-manager', {
    schema: {
      maxNPCs: {type: 'number', default: 256}, // Maximum number of NPCs to spawn
      spawnRadius: {type: 'number', default: 100}, // Radius within which to spawn NPCs
      activationDistance: {type: 'number', default: 350} // Distance at which NPCs become active
    },
    ...
    updateNPCs: function() {
      ...
      if (this.npcs.length < this.data.maxNPCs) {
        this.spawnNPC();
      }
