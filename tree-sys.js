document.addEventListener('DOMContentLoaded', () => {
    ...
    if (scene) {
      scene.addEventListener('loaded', () => {
        ...
        cloudSystemEntity.setAttribute('id', 'dentrix');
        cloudSystemEntity.setAttribute('tree-system', '');
        scene.appendChild(cloudSystemEntity);
        console.log('Eigengrau trees loaded.');
      });
    }
  });
...
AFRAME.registerComponent('tree-system', {
    ...
    schema: {
        ...
        minOpacity: { type: 'number', default: 0.7 },         // Minimum opacity for grass blades
        maxOpacity: { type: 'number', default: 0.9 }          // Maximum opacity for grass blades
    },
    ...
    init: function () {
        ...
        this.geometry = new THREE.PlaneGeometry(2, 10); // Width and unit height (will be scaled)
